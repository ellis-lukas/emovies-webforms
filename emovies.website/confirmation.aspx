            ...
            <asp:Repeater ID="RepeaterConfirmation" runat="server">
                <ItemTemplate>
                    <div class="summary-row">
                        <div class="summary-row__cell summary-row__cell--movie"><%# CurrentMovies[(Int32)Eval("MovieId")].Name %></div>
                        <div class="summary-row__cell summary-row__cell--order"><%# Eval("Price") %></div>
                    </div>
                </ItemTemplate>
            </asp:Repeater>
